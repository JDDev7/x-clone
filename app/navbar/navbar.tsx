...
function Navbar() {
  return (
    <nav className={style.navbarContainer}>
        ...
        <div className='flex flex-row items-center justify-start text-center gap-1 w-[200px]'><IconBell /><Link href="/notifications" className={style.navbarLink}> Notifications</Link></div>
